...
/**
 * @file
 * @brief Core Engine Monitoring low level API
 ...
 * (i.e., call the <code>LLTRACE_start()</code> function). If <code>auto_start</code>
 * is false, the monitoring traces must not be generated until the function
 * <code>LLTRACE_start()</code> is called. Even if <code>auto_start</code> is false,
 * the Core Engine will call the LLMJVM_MONITOR_IMPL_* functions.
 *
 * @param auto_start
...
/**
 * This function is called during Core Engine end.
 * It may be used to freed specific data.
 */
void LLMJVM_MONITOR_IMPL_on_shutdown(void);

/**
 * This function is called by the Core Engine when a new Java thread
 * is started.
 * <p>
...
/**
 * This function is called by the Core Engine when the priority or
...
/**
 * This function is called by the Core Engine when the state of a
...
/**
 * This function is called by the Core Engine when it enter in idle
 * mode (i.e., all the Java threads are sleeping).
 */
void LLMJVM_MONITOR_IMPL_on_idle(void);

/**
 * This function is called by the Core Engine when a garbage collector
...
/**
 * This function is called by the Core Engine when a new Java object is
 * allocated.
 *
 * @param type
...
/**
 * This function is called by the Core Engine when a Java exception
 * is thrown.
 *
 ...
 *
 * @param context_id
 * 		ID of the execution context being updated.
 *
 * @param quota
 * 		The new quota assigned to the execution context.
 */
 ...
 *
 * @param context_id
 * 		ID of the execution context which quota is reached.
 */
