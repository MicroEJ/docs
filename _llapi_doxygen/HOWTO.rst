...
When updating the versions of *.h files, don't forget to also update the architecture and/or library versions on top of ``llapi.rst`` and ``sniApi.rst`` in ``VEEPortingGuide/appendix`` folder.
