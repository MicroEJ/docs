...
For this getting started, we will use the `i.MX93 VEE Port module <https://forge.microej.com/ui/native/microej-developer-repository-release/com/microej/veeport/imx93/vee-port/>`__
