...
The color of the rectangles can be configured by setting the ``ej.fp.brs.drawnColor`` option to any 24-bit RGB color.
...
The color of the rectangles can be configured by setting the ``ej.fp.brs.restoredColor`` option can be set to any 24-bit RGB color to highlight these regions.
...
The color of the rectangles can be configured by setting the ``ej.fp.brs.dirtyColor`` option to any 32-bit ARGB color (opaque or semi-transparent).
