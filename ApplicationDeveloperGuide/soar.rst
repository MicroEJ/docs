...
Starting from :ref:`Architecture 8.1.0 <changelog-8.1.0>`, a default Bytecode Verifier implementation, derived from the Apache BCEL Project <https://commons.apache.org/proper/commons-bcel/>, is now included.
