...
MicroEJ provides the capability to develop parts of an application in C or C++, so called _Managed C_. Essentially, a MicroEJ Application boots in Java and then runs a mix of Java and Managed C or C++ code.
