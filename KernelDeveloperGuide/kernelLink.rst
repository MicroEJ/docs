...
- ``com.microej.soar.kernel.featureportabilitycontrol.metadata.path``: Path to the previous Kernel Metadata file (``.kdat`` file) for which retrocompatibility should be maintained.
