...
.. tabs::
   ...
   .. tab:: SDK 6
      ...
      - Within the KF test, create the sub-projects:
        ...
        - Create a new ``kernel`` directory and :ref:`create a Kernel <multisandbox_firmware_creation>`,
      ...
      Each KF test must contain a Kernel project named ``kernel`` and one or more Feature projects whose names are prefixed by ``app``.
