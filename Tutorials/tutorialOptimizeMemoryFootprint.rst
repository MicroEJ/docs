...
- Avoid using the `service <https://repository.microej.com/modules/ej/library/runtime/service/>`_ library, use singletons or `Constants.getClass() <https://repository.microej.com/javadoc/microej_5.x/apis/ej/bon/Constants.html#getClass-java.lang.String->`_ instead. The service library requires embedding class reflection methods and the type names of both interfaces and implementations.
...
The `ej.service.ServiceLoader <https://repository.microej.com/javadoc/microej_5.x/apis/ej/service/ServiceLoader.html>`_ class of the `service <https://repository.microej.com/modules/ej/library/runtime/service/>`_ library is a dependency injection facility.
