...
- The list can be optimized for the scroll (to exclude the items that are outside the visible area).
  A scrollable list is available in `Widget Examples <https://github.com/MicroEJ/Example-Java-Widget/blob/master/src/main/java/com/microej/demo/widget/common/scroll/ScrollableList.java>`__.
