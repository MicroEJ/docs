...
- by adding the mock module as a regular Platform :ref:`module dependency <mmm_module_dependency>` (if your Platform configuration project contains a ``module.ivy`` file), 
