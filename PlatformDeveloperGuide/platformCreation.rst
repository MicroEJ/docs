...
- Edit the :ref:`mmm_module_description` ``module.ivy`` to declare the MicroEJ Architecture dependency:
  ...
  Check the table of your corresponding MicroEJ Architecture and follow the link in the module column.
  ...
  And the module for this Architecture is located `here <https://repository.microej.com/modules/com/microej/architecture/CM4/CM4hardfp_GCC48/flopi4G25/7.14.0/>`.
