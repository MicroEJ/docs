...
- the custom ``com.microej.artifact.usage`` attribute, set to ``wpk``
...
- the custom ``com.microej.artifact.usage`` attribute, set to ``executable``
...
- the custom ``com.microej.artifact.usage`` attribute, set to ``executable-build-files``
...
- the custom ``com.microej.artifact.usage`` attribute, set to ``vee``
...
- the custom ``com.microej.artifact.usage`` attribute, set to ``feature-build-files``
...
- the custom ``com.microej.artifact.usage`` attribute, set to ``runtime-environment``
...
This variant is used to fetch the VEE Port and its compile dependencies when it is declared with the ``microejVee`` configuration in your project.
It is configured with the following attributes:
