...
Resolving a VEE Port transitively allows to fetch the SDK 6 Libraries provided by the VEE Port to build the compile classpath and runtime classpath of a project,
...
- The Libraries defined with ``implementation`` and their transitive dependencies are added to the compile classpath and runtime classpath of the project.
...
.. warning::
   ...
   it is highly recommended to update your VEE Port as the feature will be enabled by default in the next SDK 6 major version.
