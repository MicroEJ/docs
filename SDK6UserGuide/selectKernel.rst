...
.. warning::
   ...
   The transitive resolution of a Kernel is not supported for Kernels built with SDK 5 or SDK 6 ``1.3.0`` or older and local Kernels.
...
When the feature is enabled, the Runtime Environment of the Kernel is fetched to build the compile classpath and the Kernel's transitive dependencies are fetched 
to build the runtime classpath of the project. 
