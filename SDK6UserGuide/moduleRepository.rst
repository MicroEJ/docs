...
dependencies of a Module Repository project. The checkers can be enabled or disabled on specific dependencies by defining 
...
- With the ``module-repository.gradle.kts`` script found in the Module Repository unzipped folder, 
  add the ``apply`` declaration in your ``settings.gradle.kts`` file of your project to declare the repository:
