...
.. tabs::
   ...
   .. tab:: SDK 6
      ...
      A Front Panel project template is available as part of the `VEE Port project template <https://github.com/MicroEJ/Tool-Project-Template-VEEPort/tree/1.3.0>`_.
