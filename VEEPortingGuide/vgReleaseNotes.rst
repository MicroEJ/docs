...
.. XXX_TODO add a reference to Nema and to :ref:`section_ui_c-module-microui-nemagfx`

The following table describes the compatibility ranges between the VG Packs and the C modules (generic and specific):

+---------------+---------+----------+----------+----------------+----------------+--------------+
| VG Pack       | MicroVG | FreeType | Harfbuzz | MicroUI-VGLite | MicroVG-VGLite | MicroVG-Nema |
+===============+=========+==========+==========+================+================+==============+
| 1.6.0         | 5.0.0   | 2.0.2    | 1.0.2    | [8.0.0-8.0.1]  | 7.0.1          | 1.0.0        |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| 1.5.1         | 5.0.0   | 2.0.2    | 1.0.2    | [8.0.0-8.0.1]  | 7.0.1          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| 1.5.0         | 5.0.0   | 2.0.2    | 1.0.2    | [8.0.0-8.0.1]  | 7.0.0          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| 1.4.2         | 4.0.0   | 2.0.2    | 1.0.2    | 7.2.0          | 6.1.1          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| [1.4.0-1.4.1] | 3.0.1   | 2.0.2    | 1.0.2    | [7.0.0-7.1.0]  | [6.0.0-6.1.0]  | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| 1.3.0         | 3.0.0   | 2.0.2    | 1.0.2    | 6.0.1          | 5.0.1          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| [1.2.0-1.2.1[ | 2.1.0   | 2.0.2    | 1.0.2    | 5.0.1          | 4.0.4          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| [1.1.0-1.1.1[ | 2.0.0   | 2.0.2    | 1.0.2    | 3.0.0          | 3.0.2          | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+
| [1.0.0-1.1.0[ | n/a     | n/a      | n/a      | n/a            | n/a            | n/a          |
+---------------+---------+----------+----------+----------------+----------------+--------------+

XXX_TODO Reformulate this.
