...
.. tabs::
   ...
   .. group-tab:: SDK 6
      ...
      - the ``validation`` folder of the `VEE Port Project Template <https://github.com/MicroEJ/Tool-Project-Template-VEEPort/tree/1.5.0/vee-port/validation>`__ for the Java Testsuites.
...
<https://github.com/MicroEJ/Tool-Project-Template-VEEPort/tree/1.5.0/vee-port/validation>`__ for more
...
.. list-table:: MicroVG API Implementation and Validation
   ...
   * - 1.8.0
     ...
     - `4.2.1 <https://repository.microej.com/modules/com/microej/pack/vg/vg-testsuite/4.2.0/>`__
   * - 1.7.2
     - `1.5.2 <https://repository.microej.com/modules/ej/api/microvg/1.5.2/>`__
