...
+=================+====================+=========================================================+
| [13.5.0-14.4.1] | [7.16.0-9.0.0[     | Compatibility with Architecture 8                       |
+-----------------+--------------------+---------------------------------------------------------+
...
+=================+==================================================================+
| [14.0.0-14.4.1] | Signature of ``LLUI_DISPLAY_IMPL_flush()`` changed.              |
+-----------------+------------------------------------------------------------------+
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.4.1] | *UI3* format: implement ``LLUI_INPUT_impl.h``:                   |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.4.1] | *UI3* format: implement ``LLUI_LED_impl.h``:                     |
|                 |                                                                  |
...
+=====================+=============================+==============+
| 5.3.0               | [14.4.0-14.4.1]             | `Developer`_ |
+---------------------+-----------------------------+--------------+
...
+=================+===============+==========================+==========================================+
| [14.1.1-14.4.1] | 7.0.0         | Identical to the UI Pack | Font extensibility                       |
+-----------------+---------------+--------------------------+------------------------------------------+
...
+=================+===============+==========================+==========================================+
| [14.1.1-14.4.1] | 10.0.0        | Identical to the UI Pack | Font extensibility                       |
+-----------------+---------------+--------------------------+------------------------------------------+
...
+=================+=========+==========================+==============================+
| [14.1.1-14.4.1] | 4.0.0   | Identical to the UI Pack | Font extensibility           |
+-----------------+---------+--------------------------+------------------------------+
