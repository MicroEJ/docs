...
+=================+====================+=========================================================+
| [13.0.0-13.4.0] | [7.13.0-8.0.0[     | SNI 1.3                                                 |
+-----------------+--------------------+---------------------------------------------------------+
...
+=================+==================================================================+
| [13.0.0-13.4.0] | *UI3* format: implement ``LLUI_DISPLAY_impl.h``:                 |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-13.4.0] | *UI3* format: implement ``LLUI_INPUT_impl.h``:                   |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-13.4.0] | *UI3* format: implement ``LLUI_LED_impl.h``:                     |
|                 |                                                                  |
...
+=================+=============================================+===================+
| [13.0.0-13.4.0] | `com.microej.pack.ui.ui-pack(frontpanel)`_  | |UIPACKVERSION|   |
+-----------------+---------------------------------------------+-------------------+
...
| UI Pack Range   | Module                                          | Version           |
+=================+=================================================+===================+
| [13.0.0-13.4.0] | `com.microej.pack.ui.ui-pack(imagegenerator)`_  | |UIPACKVERSION|   |
+-----------------+-------------------------------------------------+-------------------+
