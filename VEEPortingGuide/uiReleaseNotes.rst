...
+=================+====================+=========================================================+
| [13.5.0-14.5.1] | [7.16.0-9.0.0[     | Compatibility with Architecture 8                       |
+-----------------+--------------------+---------------------------------------------------------+
...
+=================+==================================================================+
| [14.0.0-14.5.1] | Signature of ``LLUI_DISPLAY_IMPL_flush()`` changed.              |
+-----------------+------------------------------------------------------------------+
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.5.1] | *UI3* format: implement ``LLUI_INPUT_impl.h``:                   |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.5.1] | *UI3* format: implement ``LLUI_LED_impl.h``:                     |
|                 |                                                                  |
...
+=====================+=============================+==============+
| [5.3.1-5.3.2]       | [14.4.1-14.5.1]             | `Developer`_ |
+---------------------+-----------------------------+--------------+
| [5.1.0-5.2.0]       | [14.3.1-14.3.3]             | `Developer`_ |
+---------------------+-----------------------------+--------------+
| 5.0.0               | 14.3.0                      | `Developer`_ |
+---------------------+-----------------------------+--------------+
...
+------------------+--------------------------+------------------------------------------+
| [14.0.0-14.0.3]  | [4.0.0-4.1.0]            | Buffer refresh strategies                |
+------------------+--------------------------+------------------------------------------+
...
+=================+===============+==========================+==========================================+
| 14.5.1          | 8.0.0         | Identical to the UI Pack | New options convention                   |
+-----------------+---------------+--------------------------+------------------------------------------+
| [14.1.1-14.4.2] | [7.0.0-7.0.1] | Identical to the UI Pack | Font extensibility                       |
+-----------------+---------------+--------------------------+------------------------------------------+
| [14.0.1-14.0.3] | [5.0.1-6.0.0] | [4.0.1-4.1.0]            | C modules harmonization                  |
+-----------------+---------------+--------------------------+------------------------------------------+
...
+=================+=================+==========================+==========================================+
| 14.5.1          | 11.0.0          | Identical to the UI Pack | New options convention                   |
+-----------------+-----------------+--------------------------+------------------------------------------+
| [14.1.1-14.4.2] | [10.0.0-10.0.1] | Identical to the UI Pack | Font extensibility                       |
+-----------------+-----------------+--------------------------+------------------------------------------+
| [14.0.1-14.0.3] | 9.0.0           | 4.1.0                    | VG Pack extensibility                    |
+-----------------+-----------------+--------------------------+------------------------------------------+
| [14.0.1-14.0.3] | 8.0.1           | 4.0.1                    | C modules harmonization                  |
+-----------------+-----------------+--------------------------+------------------------------------------+
...
+-----------------+-----------------------------+
| VGLite C Module | VGLite Libraries Range      |
+=================+=============================+
| [8.0.0-11.0.0]  | 3.0.15_rev7                 |
+-----------------+-----------------------------+
...
+=================+===============+==========================+==============================+
| 14.5.1          | 5.0.0         | Identical to the UI Pack | New options convention       |
+-----------------+---------------+--------------------------+------------------------------+
| [14.1.1-14.4.2] | [4.0.0-4.0.1] | Identical to the UI Pack | Font extensibility           |
+-----------------+---------------+--------------------------+------------------------------+
| [14.0.1-14.0.3] | 3.0.0         | 4.1.0                    | VG Pack extensibility        |
+-----------------+---------------+--------------------------+------------------------------+
| [14.0.1-14.0.3] | 2.0.1         | 4.0.1                    | C modules harmonization      |
+-----------------+---------------+--------------------------+------------------------------+
...
+------------------+-------------------------+
| NemaGFX C Module | NemaGFX Libraries Range |
+==================+=========================+
| [4.0.0-5.0.0]    | [1.4.8-1.4.11]          |
+------------------+-------------------------+
| [1.0.0-3.0.0]    | 1.4.8                   |
+------------------+-------------------------+
