...
+=================+====================+=========================================================+
| [13.5.0-14.5.0] | [7.16.0-9.0.0[     | Compatibility with Architecture 8                       |
+-----------------+--------------------+---------------------------------------------------------+
...
+=================+==================================================================+
| [14.0.0-14.5.0] | Signature of ``LLUI_DISPLAY_IMPL_flush()`` changed.              |
+-----------------+------------------------------------------------------------------+
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.5.0] | *UI3* format: implement ``LLUI_INPUT_impl.h``:                   |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.5.0] | *UI3* format: implement ``LLUI_LED_impl.h``:                     |
|                 |                                                                  |
...
+=====================+=============================+==============+
| [5.3.1-5.3.2]       | [14.4.1-14.5.0]             | `Developer`_ |
+---------------------+-----------------------------+--------------+
...
+=================+===============+==========================+==========================================+
| 14.5.0          | 8.0.0         | Identical to the UI Pack | New options convention                   |
+-----------------+---------------+--------------------------+------------------------------------------+
...
+=================+=================+==========================+==========================================+
| 14.5.0          | 11.0.0          | Identical to the UI Pack | New options convention                   |
+-----------------+-----------------+--------------------------+------------------------------------------+
...
+=================+===============+==========================+==============================+
| 14.5.0          | 5.0.0         | Identical to the UI Pack | New options convention       |
+-----------------+---------------+--------------------------+------------------------------+
