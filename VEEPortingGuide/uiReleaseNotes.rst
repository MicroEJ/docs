...
+=================+====================+=========================================================+
| [13.5.0-14.0.2] | [7.16.0-9.0.0[     | Compatibility with Architecture 8                       |
+-----------------+--------------------+---------------------------------------------------------+
...
+=================+==================================================================+
| [14.0.0-14.0.2] | Signature of ``LLUI_DISPLAY_IMPL_flush()`` changed.              |
+-----------------+------------------------------------------------------------------+
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.0.2] | *UI3* format: implement ``LLUI_INPUT_impl.h``:                   |
|                 |                                                                  |
...
| UI Pack Range   | Changes                                                          |
+=================+==================================================================+
| [13.0.0-14.0.2] | *UI3* format: implement ``LLUI_LED_impl.h``:                     |
|                 |                                                                  |
...
+=================+============================================+=================+
| [13.0.0-14.0.2] | `com.microej.pack.ui.ui-pack(frontpanel)`_ | [13.0.0-14.0.2] |
+-----------------+--------------------------------------------+-----------------+
...
+=====================+=============================+==============+
| [4.0.0-4.0.1]       | [14.0.0-14.0.2]             | `Developer`_ |
+---------------------+-----------------------------+--------------+
...
| UI Pack Range   | Module                                          | Version           |
+=================+=================================================+===================+
| [13.0.0-14.0.2] | `com.microej.pack.ui.ui-pack(imagegenerator)`_  | [13.0.0-14.0.2]   |
+-----------------+-------------------------------------------------+-------------------+
