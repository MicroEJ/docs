...
* The optional :ref:`section.tool.fontdesigner` module, a graphical tool which runs within the MicroEJ IDE used to build and edit EJF fonts; it stores fonts in a VEE Port-independent format.
...
- For the standard FNT fonts, the *Font Designer* is useless and the font are integrated as resources by the Font Generator and loaded by the Font Loader at runtime.
